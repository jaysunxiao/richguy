...
public class DatabaseService implements ApplicationListener<ApplicationContextEvent> {
    ...
    public void onApplicationEvent(ApplicationContextEvent event) {
        if (event instanceof AppStartEvent) {
            ProtocolManager.initProtocol(Set.of(DatabasePacket.class, Message.class, PairLS.class, PairLong.class
                    , PairString.class, TripleString.class, TripleLong.class, TripleLSS.class));
